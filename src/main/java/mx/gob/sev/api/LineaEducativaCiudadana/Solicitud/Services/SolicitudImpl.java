...
public class SolicitudImpl implements SolicitudService {
    ...
    @Override
    public List<VistaSolicitud> findAllActive() {

        List<Object[]> resultados = solicitudRepository.findAllActive();
    ...
    public List<VistaSolicitud> findAllActiveByRange(String fecha_inicio, String fecha_fin) {

        List<Object[]> resultados = solicitudRepository.findAllActiveByRange(fecha_inicio, fecha_fin);
    ...
    @Override
    public List<VistaSolicitud> findCoincidenciasInicio(String atributoBusqueda, String valorBusqueda) {

        List<Object[]> resultados = solicitudRepository.findCoincidenciasInicio(
                atributoBusqueda,
                valorBusqueda);
    ...
    public List<VistaSolicitud> findAllActiveByRangeAndArea(String fecha_inicio, String fecha_fin,
            Long idAreaa) {

        List<Object[]> resultados = solicitudRepository.findAllActiveByRangeAndArea(fecha_inicio, fecha_fin,
                idAreaa);
        List<VistaSolicitud> lista = new ArrayList<>();
    ...
    public List<VistaSolicitud> findAllActiveByRangeAndAreaEstructura(String fecha_inicio, String fecha_fin,
            Long idAreaa) {

        List<Object[]> resultados = solicitudRepository.findAllActiveByRangeAndAreaEstructura(fecha_inicio, fecha_fin,
                idAreaa);
        List<VistaSolicitud> lista = new ArrayList<>();
